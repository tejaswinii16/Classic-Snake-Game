...
class Tile:
    def __init__(self, x, y):  # Corrected the method definition and indentation
        self.x = x
        self.y = y 
...
def draw():
    ...
    if(game_over):
        canvas.create_text(WINDOW_WIDTH/2, WINDOW_HEIGHT/2, font='Arial 35', text= f'GAME OVER: {score}', fill = "white")
    else:
